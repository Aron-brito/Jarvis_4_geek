...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#mybarChart").length) {
            ...
            new Chart(f, { type: "bar", data: { labels: ["Brotas", "Paripe", "Nazaré", "Ribeira", "Rio Vermelho", "Barra", "Federação"], datasets: [{ label: "# of Votes", backgroundColor: "#07060e", data: [91, 60, 75, 64, 72, 80, 65] }] }, options: { scales: { yAxes: [{ ticks: { beginAtZero: !0 } }] } } })
        }
        if ($("#mybarChart2").length) {
            var f = document.getElementById("mybarChart2");
            new Chart(f, { type: "bar", data: { labels: ["Lázaro", "Gabriel", "Vitor", "Aron", "Jadson", "Vanessa", "Maria"], datasets: [{ label: "# of Votes", backgroundColor: "#150e2f", data: [370, 310, 280, 200, 180, 175, 170] }] }, options: { scales: { yAxes: [{ ticks: { beginAtZero: !0 } }] } } })
        }
        ...
        if ($("#pieChart").length) {
            var f = document.getElementById("pieChart"),
                i = { datasets: [{ data: [1200, 500, 1400, 1800, 1000], backgroundColor: ["#455C73", "#9B59B6", "#BDC3C7", "#26B99A", "#3498DB"], label: "My dataset" }], labels: ["Colecionáveis", "Acessórios", "Camisetas", "Canecas", "Decoração"] };
